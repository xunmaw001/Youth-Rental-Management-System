    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="fangzhuId" name="fangzhuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="金额/平米" prop="fangwuPingmiJine">
                       <el-input v-model="ruleForm.fangwuPingmiJine"
                                 placeholder="金额/平米" clearable  :readonly="ro.fangwuPingmiJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="金额/平米" prop="fangwuPingmiJine">
                           <el-input v-model="ruleForm.fangwuPingmiJine"
                                     placeholder="金额/平米" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   fangwuPingmiJine: [
                              { required: true, message: '金额/平米不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
