               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="房主姓名" prop="fangzhuName">
                       <el-input v-model="ruleForm.fangzhuName"
                                 placeholder="房主姓名" clearable  :readonly="ro.fangzhuName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="房主手机号" prop="fangzhuPhone">
                       <el-input v-model="ruleForm.fangzhuPhone"
                                 placeholder="房主手机号" clearable  :readonly="ro.fangzhuPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="房主身份证号" prop="fangzhuIdNumber">
                       <el-input v-model="ruleForm.fangzhuIdNumber"
                                 placeholder="房主身份证号" clearable  :readonly="ro.fangzhuIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.fangzhuPhoto" label="房主头像" prop="fangzhuPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.fangzhuPhoto?ruleForm.fangzhuPhoto:''"
                            @change="fangzhuPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="房主电子邮箱" prop="fangzhuEmail">
                       <el-input v-model="ruleForm.fangzhuEmail"
                                 placeholder="房主电子邮箱" clearable  :readonly="ro.fangzhuEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   fangzhuPhone: [
                              {  required: true, message: '房主手机号不能为空', trigger: 'blur' },
                   ...
                   fangzhuPhoto: [
                              { required: true, message: '房主头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
                   ...
                   fangzhuEmail: [
                              { required: true, message: '房主电子邮箱不能为空', trigger: 'blur' },
                              { pattern: /^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+(.[a-zA-Z0-9_-])+/,
                                message: '房主电子邮箱只能是邮箱格式',
                                trigger: 'blur'
                              }
                          ],
                }
        ...
        methods: {
            ...
            //图片
            fangzhuPhotoUploadChange(fileUrls){
                this.ruleForm.fangzhuPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
