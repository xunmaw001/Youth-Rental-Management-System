    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(fangwu !=null){
            ...
            BeanUtils.copyProperties( fangwu , view );//把实体数据重构到view中
                ...
                //级联表
                FangzhuEntity fangzhu = fangzhuService.selectById(fangwu.getFangzhuId());
                if(fangzhu != null){
    ...
    */
    ...
    public R save(@RequestBody FangwuEntity fangwu, HttpServletRequest request){
        ...
        if(false)
            ...
            fangwu.setFangzhuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<FangwuEntity> queryWrapper = new EntityWrapper<FangwuEntity>()
            .eq("fangzhu_id", fangwu.getFangzhuId())
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            FangwuEntity fangwuEntity = new FangwuEntity();
//                            fangwuEntity.setFangzhuId(Integer.valueOf(data.get(0)));   //房主 要改的
...
//                            fangwuEntity.setFangwuPingmiJine(data.get(0));                    //金额/平米 要改的
