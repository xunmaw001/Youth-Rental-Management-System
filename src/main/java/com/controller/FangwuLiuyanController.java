    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(fangwuLiuyan !=null){
            ...
            BeanUtils.copyProperties( fangwuLiuyan , view );//把实体数据重构到view中
                ...
                //级联表
                ZukeEntity zuke = zukeService.selectById(fangwuLiuyan.getZukeId());
                if(zuke != null){
    ...
    */
    ...
    public R save(@RequestBody FangwuLiuyanEntity fangwuLiuyan, HttpServletRequest request){
        ...
        if(false)
            ...
            fangwuLiuyan.setZukeId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
...
//                            fangwuLiuyanEntity.setZukeId(Integer.valueOf(data.get(0)));   //租客 要改的
