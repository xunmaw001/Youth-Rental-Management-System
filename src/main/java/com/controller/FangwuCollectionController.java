    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(fangwuCollection !=null){
            ...
            BeanUtils.copyProperties( fangwuCollection , view );//把实体数据重构到view中
                ...
                //级联表
                ZukeEntity zuke = zukeService.selectById(fangwuCollection.getZukeId());
                if(zuke != null){
    ...
    */
    ...
    public R save(@RequestBody FangwuCollectionEntity fangwuCollection, HttpServletRequest request){
        ...
        if(false)
            ...
            fangwuCollection.setZukeId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<FangwuCollectionEntity> queryWrapper = new EntityWrapper<FangwuCollectionEntity>()
            ...
            .eq("zuke_id", fangwuCollection.getZukeId())
...
//                            fangwuCollectionEntity.setZukeId(Integer.valueOf(data.get(0)));   //租客 要改的
