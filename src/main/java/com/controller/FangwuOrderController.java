    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(fangwuOrder !=null){
            ...
            BeanUtils.copyProperties( fangwuOrder , view );//把实体数据重构到view中
                ...
                //级联表
                ZukeEntity zuke = zukeService.selectById(fangwuOrder.getZukeId());
                if(zuke != null){
    ...
    */
    ...
    public R save(@RequestBody FangwuOrderEntity fangwuOrder, HttpServletRequest request){
        ...
        if(false)
            ...
            fangwuOrder.setZukeId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
...
//            fangwuOrder.setZukeId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R shenhe(@RequestBody FangwuOrderEntity fangwuOrderEntity, HttpServletRequest request){
        logger.debug("shenhe方法:,,Controller:{},,fangwuOrderEntity:{}",this.getClass().getName(),fangwuOrderEntity.toString());

//        if(fangwuOrderEntity.getFangwuOrderYesnoTypes() == 2){//通过
//            fangwuOrderEntity.setFangwuOrderTypes();
//        }else if(fangwuOrderEntity.getFangwuOrderYesnoTypes() == 3){//拒绝
//            fangwuOrderEntity.setFangwuOrderTypes();
//        }
        fangwuOrderEntity.setFangwuOrderShenheTime(new Date());//审核时间
        fangwuOrderService.updateById(fangwuOrderEntity);//审核
        return R.ok();
    }
...
//                            fangwuOrderEntity.setZukeId(Integer.valueOf(data.get(0)));   //租客 要改的
//                            fangwuOrderEntity.setKanfangTime(sdf.parse(data.get(0)));          //看房时间 要改的
    ...
    */
    ...
    public R add(@RequestBody FangwuOrderEntity fangwuOrder, HttpServletRequest request){
        logger.debug("add方法:,,Controller:{},,fangwuOrder:{}",this.getClass().getName(),fangwuOrder.toString());
            ...
            fangwuOrder.setZukeId(userId); //设置订单支付人id
