...
public class ZulinhetongEntity<T> implements Serializable {
    ...
    public String toString() {
        return "Zulinhetong{" +
            ...
            ", fangzhuId=" + fangzhuId +
            ", zukeId=" + zukeId +
            ", zulinhetongUuidNumber=" + zulinhetongUuidNumber +
            ", zulinhetongName=" + zulinhetongName +
            ", zulinhetongFile=" + zulinhetongFile +
            ", zulinhetongTypes=" + zulinhetongTypes +
            ", zulinriqiTime=" + zulinriqiTime +
            ", zulinhetongYue=" + zulinhetongYue +
            ", zulinhetongYajinJine=" + zulinhetongYajinJine +
            ", zulinhetongJine=" + zulinhetongJine +
            ", zulinhetongContent=" + zulinhetongContent +
            ", zulinhetongYesnoTypes=" + zulinhetongYesnoTypes +
